...
class TipoEventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_evento" do
    assert_difference('TipoEvento.count') do
      post tipo_eventos_url, params: { tipo_evento: { ativo: @tipo_evento.ativo, dtCadastro: @tipo_evento.dtCadastro, nome: @tipo_evento.nome } }
    end
  ...
  test "should update tipo_evento" do
    patch tipo_evento_url(@tipo_evento), params: { tipo_evento: { ativo: @tipo_evento.ativo, dtCadastro: @tipo_evento.dtCadastro, nome: @tipo_evento.nome } }

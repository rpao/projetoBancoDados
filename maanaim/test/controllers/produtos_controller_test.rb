...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { ativo: @produto.ativo, nome: @produto.nome, obs: @produto.obs, preco: @produto.preco } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { ativo: @produto.ativo, nome: @produto.nome, obs: @produto.obs, preco: @produto.preco } }
